...
[source,bash]
----
curl -sSL -o install.hacker https://raw.githubusercontent.com/michal92299/vib-lang/main/install.hacker
hackerc run install.hacker
----
==== For every linux distro
[source,bash]
----
curl -sSL -o install.hacker https://raw.githubusercontent.com/michal92299/vib-lang/main/install.sh
./install.sh
----
